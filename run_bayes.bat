...
chcp 65001 >nul
cd /d "%~dp0"
title 気相NMR ベイズ再解析シミュレーター

echo ===============================================
echo   気相NMR ベイズ再解析シミュレーター (Windows)
echo ===============================================
echo.
...
REM --- 依存ライブラリを用意 ---
echo 依存ライブラリ (numpy, scipy) を確認中...
%PY% -m pip install --quiet --disable-pip-version-check numpy scipy
if errorlevel 1 (
